...
export default function Regulations() {
  const admissionRules = [
    { title: "نظام القبول", content: "يتم القبول من خلال مكتب تنسيق القبول بالجامعات المصرية لطلاب الثانوية العامة (علمي وأدبي) وما يعادلها، والتحويلات عن طريق إدارة الجامعة." },
  ...
  const creditHourRules = [
    ...
    { title: "مدة الدراسة", content: "مدة الدراسة ٣ سنوات ونصف (سبعة مستويات دراسية) بنظام الساعات المعتمدة." },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-10 relative z-10">
              ...
              <h2 className="text-3xl font-bold text-primary font-arabic">نظام الساعات المعتمدة</h2>
            </div>

            <div className="space-y-6 relative z-10">
              {creditHourRules.map((rule, idx) => (
                <div key={idx} className="p-6 bg-gray-50 rounded-2xl border border-transparent hover:border-accent/10 hover:bg-white hover:shadow-md transition-all group">
